...
// Placeholder icons for theme toggle
...
export const RectangleBoardIcon: React.FC<IconProps> = ({className}) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-5 h-5"}>
...
export const StoreFrontIcon: React.FC<IconProps> = ({className}) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-5 h-5"}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 21v-7.5A2.25 2.25 0 0011.25 11.25H6.75A2.25 2.25 0 004.5 13.5V21M6 10.5h12M9 10.5v-3A1.5 1.5 0 0110.5 6h3A1.5 1.5 0 0115 7.5v3M3.75 5.25c-.621 0-1.125.504-1.125 1.125v3.026a2.999 2.999 0 010 5.198v3.026c0 .621.504 1.125 1.125 1.125h16.5c.621 0 1.125-.504 1.125-1.125v-3.026a2.999 2.999 0 010-5.198V6.375c0-.621-.504-1.125-1.125-1.125H3.75z" />
  </svg>
);
...
export const MapIcon: React.FC<IconProps> = ({className}) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-5 h-5"}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 6.75V15m6-6v8.25m.503 3.498l4.875-2.437c.381-.19.622-.58.622-1.006V4.82c0-.836-.88-1.37-1.626-1.006l-4.875 2.437c-.381.19-.622.58-.622 1.006v7.689c0 .836.88 1.37 1.626 1.006zm-2.006-4.869l4.875-2.437c.381-.19.622-.58.622-1.006V4.82c0-.836-.88-1.37-1.626-1.006L9.87 6.253c-.381.19-.622.58-.622 1.006v7.689c0 .836.88 1.37 1.626 1.006l.006-.003z" />
  </svg>
);
